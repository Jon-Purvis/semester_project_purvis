...
raw_html <- read_html(here("raw_data","Tuition and Fees, 1998-99 Through 2018-19 - The Chronicle of Higher Education.htm"))
...
clean_cost_table %>% 
  write_csv(here::here("data", "tuition_cost.csv"))


# Add diversity data ------------------------------------------------------
raw_diversity <- read_html(here::here("raw_data","Student Diversity at More Than 4,600 Institutions - The Chronicle of Higher Education.htm"))
...
diversity_tab <- read_csv(here::here("raw_data","student_diversity.csv"))
...
final_table %>% 
  write_csv(here::here("data", "college_diversity.csv"))
...
clean_cost_table %>% 
  write_csv(here::here("data","total_school_cost.csv"))

 clean_div_table %>% 
  write_csv(here::here("data","diversity_school.csv"))